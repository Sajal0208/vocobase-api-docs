...
|---|---|---|
| `call.status.updated` | Real-time phone call lifecycle updates from the telephony provider | Queue orchestration, live UI state, freeing concurrency when the call reaches a terminal status |
