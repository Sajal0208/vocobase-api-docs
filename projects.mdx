...
When your account is approved, a **Default** project is automatically created. All agents created via the API are assigned to this default project unless you specify a `project_id`.

The default project cannot be deleted.

## API Endpoints

Full CRUD is available via the V2 API:
