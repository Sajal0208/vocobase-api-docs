...
For client, DID mapping, sync, and readiness checks, use the [VoiceLink Management](/telephony/voicelink-management) guide. It documents the V2 endpoints under `/api/v2/voicelink/*`, including `connection_id` support for multiple active VoiceLink connections.
