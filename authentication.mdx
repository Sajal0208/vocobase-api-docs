...
Outbound calls have a concurrency limit of **5 simultaneous active calls** per account. If you attempt to start a call while at the limit, you will receive a `429` response.
...
| `403` | `FORBIDDEN` | Your API key is valid but you do not have permission for this action. Common causes: insufficient balance (₹) or a suspended account. |
