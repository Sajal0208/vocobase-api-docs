...
<Steps>
  ...
  <Step title="Make your first call">
    ...
    The `from_number` is resolved from the selected provider connection and returned in the response. The call is placed asynchronously. Set up [webhooks](/webhooks/setup) to receive a notification when the call completes, including the full transcript and recording URL.
  </Step>
</Steps>
