...
- **Per-customer credit accounting.** Credits are billed to your partner account, not to individual customers. (Track per-customer usage from session metadata or session listing.)
