...
<Steps>
  <Step title="Sync your DIDs to Vocobase">
    ...
    **Vobiz** — pass an explicit list (Vobiz has no inventory pull):
    ...
    curl -X POST https://api.vocobase.com/api/v2/phone-numbers/sync \
      ...
      -d '{
        "provider": "VOBIZ",
        "phone_numbers": ["+918065480085", "+919109518550"]
      }'
    ```

    Response (both providers, same shape):
    ...
    ```json
    {
      ...
      "data": {
        "imported": [
          { "id": "f1a2…", "phone_number": "+918065480085", "provider": "VOBIZ" }
        ]
      }
    }
    ```
